...
# cs101-F2018-lab4-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 4 in Computer Science 101.
...
The source code in the `InsertionSort.java` file must also pass additional tests
set by the [GatorGrader tool](https://github.com/GatorEducator/gatorgrader). For
instance, GatorGrader will check to ensure that `InsertionSort` has `println`
statements that produce exactly four lines of output. More details about the
...
laboratory assignment also invites you to extend and run a comprehensive JUnit
test suite in the class called `TestInsertionSort`. You should carefully inspect
the arrays that the test suite generates so that you understand their contents
and, therefore, the strategy adopted by each of the tests.
...
- labfour/InsertionSort.java:
  ...
  - Contains exactly 4 `println` statements to produce program output
  - Contains exactly zero of the comment fragment that marks incomplete tasks
  - Passes all of the test cases defined in the `TestInsertionSort.java` file
  - Runs correctly without crashing or producing an error
  - Produces exactly 4 lines of output in the terminal
  - Produces output that contains exactly two of the fragment `Before`
  - Produces output that contains exactly two of the fragment `After`
...
you can go to the [Computer Science 101 Lab 4
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-lab4-starter)
